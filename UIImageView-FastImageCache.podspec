Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   ...
                   DESC
  s.homepage     = "https://github.com/local-projects/UIImageView-FastImageCache"
  s.screenshots  = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license      = 'MIT'
  s.author       = { "pan286" => "pan286@gmail.com" }
  s.source       = { :git => "https://github.com/local-projects/UIImageView-FastImageCache.git", :tag => s.version.to_s }
